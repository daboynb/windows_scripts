...
IF EXIST "C:\ISO\Win10" (
    color 4 && echo "ERRORE: C:\ISO\Win10 esiste già, elimina la cartella prima di procedere" && pause && exit /b 1
)
...
if %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare Unpin_start_tiles.ps1!" && pause && exit /b 1
)
