...
rem edit unattend.xml
powershell -command "Write-Host 'Insert your username for windows' -ForegroundColor Green; $newName = Read-Host ':'; (Get-Content -path win10ita\resources\unattend.xml -Raw) -replace 'nomeutente',$newName | Set-Content -Path win10ita\resources\unattend_edited.xml"
cls
powershell -command "Write-Host 'Setting up locale...' -ForegroundColor Green; $output = dism /image:C:\mount\mount /get-intl | Select-String -Pattern 'Default system UI language : (\w{2}-\w{2})' | Foreach-Object { $_.Matches.Groups[1].Value }; (Get-Content -path win10ita\resources\unattend_edited.xml -Raw) -replace 'locale_set',$output | Set-Content -Path win10ita\resources\unattend_edited.xml"
cls
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't copy unattend.xml!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't export the image!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't delete the old install.wim!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't move the new install.wim!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
goto :mountstep
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Can''t delete old install.esd!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't copy Firefox setup!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Can't copy tweaks.bat!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Can't copy Unpin_start_tiles.ps1!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Can't copy start.ps1!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Can't copy PowerRun.exe!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't build the ISO!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't copy the ISO to the desktop!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't delete the working folder1!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't delete the working folder2!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERROR: Can't delete unattend!" && pause && del "win10ita\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
rem edit unattend.xml
powershell -command "Write-Host 'Inserisci il nome che desideri per l''utente di windows' -ForegroundColor Green; $newName = Read-Host ':'; (Get-Content -path win10en\resources\unattend.xml -Raw) -replace 'nomeutente',$newName | Set-Content -Path win10en\resources\unattend_edited.xml"
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile copiare unattend.xml!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile esportare l''immagine!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
goto :copy_esd
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile eliminare old install.wim!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile spostare il nuovo install.wim!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
goto :mountstep
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile eliminare old install.esd!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile copiare l''installer di firefox!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare tweaks.bat!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare Debloat.ps1!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare Debloat.bat!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare Debloat.ink!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare Unpin_start_tiles.ps1!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare start.ps1!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "Impossibile copiare PowerRun.exe!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile creare la ISO!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile copiare la ISO sul desktop!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile eliminare le directory1 usata per la creazione della ISO!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile eliminare la directory2 usata per la creazione della ISO!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
...
IF %errorlevel% equ 0 (
  ...
  color 4 && echo "ERRORE: Impossibile eliminare unattend!" && pause && del "win10en\resources\unattend_edited.xml" /q && rmdir "C:\mount" /s /q && rmdir "C:\ISO" /s /q && exit /b 1
)
