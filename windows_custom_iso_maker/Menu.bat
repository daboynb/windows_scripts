...
IF /I '%MENU%'=='1' GOTO :submenu_11
IF /I '%MENU%'=='2' GOTO :submenu_10
...
echo.
echo *******************************
SET /P MENU=Type 1, 2, 3, 4, or 0 then press ENTER : 
...
echo *******************************
echo.
echo [1] WINDOWS 10 ITA
echo    (Crea una ISO debloated si Windows 10)
echo.
echo [2] WINDOWS 10 EN
